 ...
 * Equivalent to compiling ILlmCallback.aidl
 */
...
public interface ILlmCallback extends android.os.IInterface {
    ...
    public static class Default implements ILlmCallback {
    ...
    public static abstract class Stub extends android.os.Binder implements ILlmCallback {

        private static final String DESCRIPTOR = "space.manus.nacre.ai.ILlmCallback";
        ...
        public static ILlmCallback asInterface(android.os.IBinder obj) {
            if (obj == null) return null;
            android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin instanceof ILlmCallback) return (ILlmCallback) iin;
        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            switch (code) {
                case TRANSACTION_onResult: {
                    ...
                    this.onResult(data.readString());
                    return true;
                }
                case TRANSACTION_onPartialResult: {
                    data.enforceInterface(DESCRIPTOR);
                    this.onPartialResult(data.readString());
                    return true;
                }
                case TRANSACTION_onError: {
                    data.enforceInterface(DESCRIPTOR);
                    this.onError(data.readString());
                    return true;
                }
            }
        ...
        private static class Proxy implements ILlmCallback {
